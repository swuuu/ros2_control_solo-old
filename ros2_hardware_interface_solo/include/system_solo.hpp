...
#ifndef ROS2_CONTROL_SOLO__SYSTEM_SOLO_HPP_
#define ROS2_CONTROL_SOLO__SYSTEM_SOLO_HPP_
...
std::set<std::string> solo_list_of_cmd_inter {
  "position",
  "velocity",
  "effort",
  "gain_kp",
...
std::set<std::string> solo_list_of_state_inter {
  "position",
  "velocity",
  "effort",
  "gain_kp",
...
class SystemSoloHardware : public
  hardware_interface::BaseInterface<hardware_interface::SystemInterface>
{
public:

  RCLCPP_SHARED_PTR_DEFINITIONS(SystemSoloHardware)

  ROS2_CONTROL_SOLO_PUBLIC
...
private:
  ...
  //Definition of multiple variables about Solo
  // Joint
...
#endif  // ROS2_CONTROL_SOLO__SYSTEM_SOLO_HPP_
