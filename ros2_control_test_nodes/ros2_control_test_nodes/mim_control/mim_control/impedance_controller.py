##################################################################################################################
## This is the implementation for mim_control controller between any two frames of the robot.
...
class ImpedanceController(object):
    def __init__(
        ...
        """
        Input :
            name : Name of the mim_control controller (Ex. Front left leg mim_control)
    ...
    def compute_impedance_torques_world(self, q, dq, kp, kd, x_des, xd_des, f):
        """Computes the leg mim_control using world coordinate x_des and xd_des.
